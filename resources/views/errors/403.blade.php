...
@section('title', '403 | ПАТИМЕНЕДЖЕР')
...
@section('content')
    ...
    <main class="container min-h-[90vh] flex justify-center items-center relative">
        ...
        <div class="text-center">
            <h1 class="font-semibold text-4xl">403</h1>
            <p class="font-light text-lg opacity-50 pt-2.5 pb-7.5">Кажется, у вас нет доступа к этой странице.</p>
            <a class="px-4 py-2 font-semibold border border-[#0000001a] rounded-xl bg-[#FFD700] " href="{{ route('specialists') }}">К специалистам</a>
        </div>
