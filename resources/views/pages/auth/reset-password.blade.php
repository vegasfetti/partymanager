...
@section('title', 'Новый пароль | ПАТИМЕНЕДЖЕР')
...
@section('content')
    ...
    <main class="container min-h-screen relative px-4 sm:px-6 lg:px-8">
        ...
        <form method="post" action="{{ route('password.update') }}"
            ...
            <p class="font-light text-base sm:text-lg opacity-50 pt-2.5 pb-6 sm:pb-7.5">Введите новый пароль</p>
            ...
            <div class="inputs flex flex-col gap-2.5">
                ...
                <button
                    class="waiting bg-[#FFD700] font-semibold text-[#1C1F4C] mt-5 px-3.5 sm:px-4 py-2.5 sm:py-3 border border-[#0000001a] rounded-xl cursor-pointer w-full sm:w-auto text-base sm:text-sm">
                    Сбросить
                </button>

                <p class="text-sm sm:text-base text-gray-500 text-center pt-5">
                    Вспомнили пароль? <a class="text-[#FFD700] underline" href="{{ route('signin') }}">Войти</a>
                </p>
            </div>
        </form>
